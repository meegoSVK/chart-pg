...
#re.findall nachadza vsetky vyskyti pouziteho retazca - 28-* oznacuje directory a zaroven je aj IDckom cidla - v ceste nacitaych filoch do !LISTu! - [0] z toho robi string, pretoza alokuje len jednu hodnotu
...
#uzatvorenie subou, pretoze inak si ho python drzi otvoreny v procese a moze blokovat
    file.close()
#Vypis zisteni - na poslednom riadku sa pouziva [:2] a [2:] na vlozenie bodky do printu - bude to nutne na integraciu do DB.
    print(file_open)
